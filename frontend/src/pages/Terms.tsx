          ...
          <CardContent className="prose prose-sm sm:prose max-w-none space-y-6">
            <section>
              ...
              <p className="text-muted-foreground">
                By accessing and using Custom Graphics, you accept and agree to be bound by the terms and 
            ...
            <section>
              ...
              <p className="text-muted-foreground mb-2">
                Permission is granted to temporarily download one copy of the materials on Custom Graphics 
              ...
              <ul className="list-disc list-inside space-y-1 text-muted-foreground ml-4">
                ...
                <li>Attempt to reverse engineer any software contained on Custom Graphics</li>
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                ...
                are estimates and not guaranteed. Custom Graphics is not responsible for delays caused by 
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                ...
                software, is the property of Custom Graphics and is protected by copyright and trademark laws. 
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                Custom Graphics shall not be liable for any indirect, incidental, special, consequential, or 
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                ...
                Raj@customgraphics.com or call 855-271-2680.
              </p>
            </section>
          </CardContent>
        </Card>
